...
*&
*&---------------------------------------------------------------------*
REPORT  zhms_carga_dcitm.

DATA: itxls     TYPE STANDARD TABLE OF kcde_cells,
      waxls     TYPE kcde_cells.

DATA: lt_dcitm TYPE STANDARD TABLE OF zhms_tb_dcitm,
      ls_dcitm LIKE LINE OF lt_dcitm.
...
FORM insert_table .
  ...
  IF sy-subrc IS INITIAL.
    MODIFY zhms_tb_dcitm FROM TABLE lt_dcitm.
    IF sy-subrc IS INITIAL.
      COMMIT WORK.
