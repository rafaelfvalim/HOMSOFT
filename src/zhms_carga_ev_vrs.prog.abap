...
DATA: lt_ev_vrs TYPE STANDARD TABLE OF zhms_tb_ev_vrs,
      ls_ev_vrs LIKE LINE OF lt_ev_vrs.
...
FORM insert_table .
  ...
  LOOP AT itxls INTO waxls.
    ...
    CASE waxls-col.
      WHEN '1'.
        IF ls_ev_vrs IS NOT INITIAL.
          APPEND ls_ev_vrs TO lt_ev_vrs.
          CLEAR ls_ev_vrs.
        ENDIF.
        MOVE waxls-value TO ls_ev_vrs-natdc.
      WHEN '2'.
        MOVE waxls-value TO ls_ev_vrs-typed.
      WHEN '3'.
        MOVE waxls-value TO ls_ev_vrs-loctp.
      WHEN '4'.
        MOVE waxls-value TO ls_ev_vrs-event.
      WHEN '5'.
        MOVE waxls-value TO ls_ev_vrs-versn.
      WHEN '6'.
        MOVE waxls-value TO ls_ev_vrs-ativo.
        APPEND ls_ev_vrs TO lt_ev_vrs.
        CLEAR ls_ev_vrs.
    ENDCASE.
  ...
  IF sy-subrc IS INITIAL.
    MODIFY zhms_tb_ev_vrs FROM TABLE lt_ev_vrs.
    IF sy-subrc IS INITIAL.
      COMMIT WORK.
