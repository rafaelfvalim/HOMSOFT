...
*&
*&---------------------------------------------------------------------*
REPORT  zhms_carga_fildcitm.

DATA: itxls     TYPE STANDARD TABLE OF kcde_cells,
      waxls     TYPE kcde_cells.

DATA: lt_fildcitm TYPE STANDARD TABLE OF zhms_tb_fildcitm,
      ls_fildcitm LIKE LINE OF lt_fildcitm.
...
*** Carrega TXT
  ...
  LOOP AT lt_data INTO wa_data.
    ...
    SPLIT wa_data AT con_tab INTO
                              ls_fildcitm-codmp
                              ls_fildcitm-denom
                              ls_fildcitm-mneumpai
                              ls_fildcitm-mneumval.


    APPEND ls_fildcitm TO lt_fildcitm.
    CLEAR ls_fildcitm.
...
FORM insert_table .
  ...
  IF sy-subrc IS INITIAL.
    MODIFY zhms_tb_fildcitm FROM TABLE lt_fildcitm.
    IF sy-subrc IS INITIAL.
      COMMIT WORK.
