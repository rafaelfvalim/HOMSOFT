...
*&
*&---------------------------------------------------------------------*
REPORT  zhms_carga_gatemneu.

DATA: itxls     TYPE STANDARD TABLE OF kcde_cells,
      waxls     TYPE kcde_cells.

DATA: lt_gatemneu TYPE STANDARD TABLE OF zhms_tx_gatemneu,
...
FORM insert_table .
  ...
  LOOP AT itxls INTO waxls.
    ...
    CASE waxls-col.
      ...
      WHEN '3'.
        MOVE waxls-value TO ls_gatemneu-spras.
      WHEN '4'.
        MOVE waxls-value TO ls_gatemneu-denom.
  ...
  IF sy-subrc IS INITIAL.
    MODIFY zhms_tx_gatemneu FROM TABLE lt_gatemneu.
    IF sy-subrc IS INITIAL.
      COMMIT WORK.
