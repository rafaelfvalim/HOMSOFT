...
*&
*&---------------------------------------------------------------------*
REPORT  zhms_carga_mapconec.

DATA: itxls     TYPE STANDARD TABLE OF kcde_cells,
      waxls     TYPE kcde_cells.

DATA: lt_mapconec TYPE STANDARD TABLE OF zhms_tb_mapconec,
      ls_mapconec LIKE LINE OF lt_mapconec.
...
*** Carrega TXT
  ...
  LOOP AT lt_data INTO wa_data.
    ...
    APPEND ls_mapconec TO lt_mapconec.
    CLEAR ls_mapconec.
...
FORM insert_table .
  ...
  IF sy-subrc IS INITIAL.
    MODIFY zhms_tb_mapconec FROM TABLE lt_mapconec.
    IF sy-subrc IS INITIAL.
      COMMIT WORK.
