...
*&
*&---------------------------------------------------------------------*
REPORT  zhms_carga_mapdata.

DATA: itxls     TYPE STANDARD TABLE OF kcde_cells,
      waxls     TYPE kcde_cells.

DATA: lt_mapdata TYPE STANDARD TABLE OF zhms_tb_mapdata,
...
FORM insert_table .
  ...
  LOOP AT itxls INTO waxls.
    ...
    CASE waxls-col.
      WHEN '1'.
        IF ls_mapdata IS NOT INITIAL.
          APPEND ls_mapdata TO lt_mapdata.
          CLEAR ls_mapdata.
        ENDIF.
        MOVE waxls-value TO ls_mapdata-codmp.
      WHEN '2'.
        MOVE waxls-value TO ls_mapdata-seqnr.
      WHEN '3'.
        MOVE waxls-value TO ls_mapdata-mpgrp.
      WHEN '4'.
        MOVE waxls-value TO ls_mapdata-mneum.
      WHEN '5'.
        MOVE waxls-value TO ls_mapdata-mnitm.
      WHEN '6'.
        MOVE waxls-value TO ls_mapdata-natfd.
      WHEN '7'.
        MOVE waxls-value TO ls_mapdata-tpvar.
      WHEN '8'.
        MOVE waxls-value TO ls_mapdata-tbnam.
      WHEN '9'.
        MOVE waxls-value TO ls_mapdata-tbfld.
      WHEN '10'.
        MOVE waxls-value TO ls_mapdata-vlfix.
      WHEN '11'.
        MOVE waxls-value TO ls_mapdata-mask.
      WHEN '12'.
        MOVE waxls-value TO ls_mapdata-rotin.
        APPEND ls_mapdata TO lt_mapdata.
        CLEAR ls_mapdata.
    ENDCASE.
  ...
  IF sy-subrc IS INITIAL.
    MODIFY zhms_tb_mapdata FROM TABLE lt_mapdata.
    IF sy-subrc IS INITIAL.
      COMMIT WORK.
