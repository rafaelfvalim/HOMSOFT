...
*&
*&---------------------------------------------------------------------*
REPORT  zhms_carga_mappcone.

DATA: itxls     TYPE STANDARD TABLE OF kcde_cells,
      waxls     TYPE kcde_cells.

DATA: lt_mappcone TYPE STANDARD TABLE OF zhms_tb_mappcone,
      ls_mappcone LIKE LINE OF lt_mappcone.
...
*** Carrega TXT
  ...
  LOOP AT lt_data INTO wa_data.
    ...
    APPEND ls_mappcone TO lt_mappcone.
    CLEAR ls_mappcone.
...
FORM insert_table .
  ...
  IF sy-subrc IS INITIAL.
    MODIFY zhms_tb_mappcone FROM TABLE lt_mappcone.
    IF sy-subrc IS INITIAL.
      COMMIT WORK.
