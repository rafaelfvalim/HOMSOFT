...
*&
*&---------------------------------------------------------------------*
REPORT  zhms_carga_mapping_tx.

DATA: itxls     TYPE STANDARD TABLE OF kcde_cells,
      waxls     TYPE kcde_cells.

DATA: lt_tx_mapping TYPE STANDARD TABLE OF zhms_tx_mapping,
      ls_tx_mapping LIKE LINE OF lt_tx_mapping.
...
*** Carrega TXT
  ...
  LOOP AT lt_data INTO wa_data.
    ...
    APPEND ls_tx_mapping TO lt_tx_mapping.
    CLEAR ls_tx_mapping.
...
FORM insert_table .
  ...
  IF sy-subrc IS INITIAL.
    MODIFY zhms_tx_mapping FROM TABLE lt_tx_mapping.
    IF sy-subrc IS INITIAL.
      COMMIT WORK.
