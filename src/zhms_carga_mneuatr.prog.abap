...
*&
*&---------------------------------------------------------------------*
REPORT  zhms_carga_mneuatr.

DATA: itxls     TYPE STANDARD TABLE OF kcde_cells,
      waxls     TYPE kcde_cells.

DATA: lt_mneuatr TYPE STANDARD TABLE OF zhms_tb_mneuatr,
...
FORM insert_table .
  ...
  LOOP AT itxls INTO waxls.
    ...
    CASE waxls-col.
      WHEN '1'.
        IF ls_mneuatr IS NOT INITIAL.
          APPEND ls_mneuatr TO lt_mneuatr.
          CLEAR ls_mneuatr.
        ENDIF.
        MOVE waxls-value TO ls_mneuatr-mnorg.
      WHEN '2'.
        MOVE waxls-value TO ls_mneuatr-mndst.
        APPEND ls_mneuatr TO lt_mneuatr.
        CLEAR ls_mneuatr.
    ENDCASE.
  ...
  IF sy-subrc IS INITIAL.
    MODIFY zhms_tb_mneuatr FROM TABLE lt_mneuatr.
    IF sy-subrc IS INITIAL.
      COMMIT WORK.
