...
FORM insert_table .
  ...
  LOOP AT itxls INTO waxls.
    ...
    CASE waxls-col.
      WHEN '1'.
        IF ls_msgevl_a IS NOT INITIAL.
          APPEND ls_msgevl_a TO lt_msgevl_a.
        ENDIF.
        MOVE waxls-value TO ls_msgevl_a-natdc.
      WHEN '2'.
        MOVE waxls-value TO ls_msgevl_a-typed.
      WHEN '3'.
        MOVE waxls-value TO ls_msgevl_a-loctp.
      WHEN '4'.
        MOVE waxls-value TO ls_msgevl_a-mensg.
      WHEN '5'.
        MOVE waxls-value TO ls_msgevl_a-event.
      WHEN '6'.
        MOVE waxls-value TO ls_msgevl_a-versn.
      WHEN '7'.
        MOVE waxls-value TO ls_msgevl_a-codly.
      WHEN '8'.
        MOVE waxls-value TO ls_msgevl_a-codat.
      WHEN '9'.
        MOVE waxls-value TO ls_msgevl_a-field.
      WHEN '10'.
        MOVE waxls-value TO ls_msgevl_a-value.
        APPEND ls_msgevl_a TO lt_msgevl_a.
        CLEAR ls_msgevl_a.
    ENDCASE.
