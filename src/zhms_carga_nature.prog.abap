...
DATA: lt_nature TYPE STANDARD TABLE OF zhms_tb_nature,
      ls_nature LIKE LINE OF lt_nature.
...
FORM insert_table .
  ...
  LOOP AT itxls INTO waxls.
    ...
    CASE waxls-col.
      WHEN '1'.
        MOVE waxls-value TO ls_nature-natdc.
      WHEN '2'.
        MOVE waxls-value TO ls_nature-icons.
      WHEN '3'.
        MOVE waxls-value TO ls_nature-detsc.
        APPEND ls_nature TO lt_nature.
        CLEAR ls_nature .
    ENDCASE.
  ...
  IF sy-subrc IS INITIAL.
    MODIFY zhms_tb_nature FROM TABLE lt_nature.
    IF sy-subrc IS INITIAL.
      COMMIT WORK.
