...
*&
*&---------------------------------------------------------------------*
REPORT  zhms_carga_tx_pkgvld.

DATA: itxls     TYPE STANDARD TABLE OF kcde_cells,
      waxls     TYPE kcde_cells.

DATA: lt_tx_pkgvld TYPE STANDARD TABLE OF zhms_tx_pkgvld,
      ls_tx_pkgvld LIKE LINE OF lt_tx_pkgvld.
...
FORM insert_table .
  ...
  LOOP AT itxls INTO waxls.
    ...
    CASE waxls-col.
      WHEN '1'.
        IF ls_tx_pkgvld IS NOT INITIAL.
          APPEND ls_tx_pkgvld TO lt_tx_pkgvld .
          CLEAR ls_tx_pkgvld.
        ENDIF.
        MOVE waxls-value TO ls_tx_pkgvld-vldcd.
      WHEN '2'.
        MOVE waxls-value TO ls_tx_pkgvld-spras.
      WHEN '3'.
        MOVE waxls-value TO ls_tx_pkgvld-denom.
        APPEND ls_tx_pkgvld TO lt_tx_pkgvld.
        CLEAR ls_tx_pkgvld.
    ENDCASE.
  ...
  IF sy-subrc IS INITIAL.
    MODIFY zhms_tx_pkgvld FROM TABLE lt_tx_pkgvld .
    IF sy-subrc IS INITIAL.
      COMMIT WORK.
