FUNCTION zhms_fm_get_html_home .
*"----------------------------------------------------------------------
*"*"Interface local:
*"  TABLES
...
** Funções JS
  APPEND: '<script language="javascript">' TO srscd,
          ...
          '	' TO srscd,
          '	document.getElementById(div).className = newclass;' TO srscd,
          '	document.getElementById("descricao").innerHTML = "<img src=''hms_applogo.gif'' />";' TO srscd,
          '}' TO srscd,
          '' TO srscd,
...
* Inicio Corpo HTML
  ...
  APPEND: '<div id="rodape" style="width:100%;">' TO srscd,
          '<div id="descricao" class="txt_desc" align="center"><img src="hms_applogo.gif" /></div>' TO srscd,
          '</div>' TO srscd,
          '</div>' TO srscd.
