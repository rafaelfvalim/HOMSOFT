*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZHMS_VW_EVENTS
*   generation date: 05.04.2013 at 19:20:58 by user CLEBER
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZHMS_VW_EVENTS      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZHMS_VW_EVENTS'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZHMS_VW_EVENTS_EXTRACT
TOTAL = ZHMS_VW_EVENTS_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZHMS_VW_EVENTS'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZHMS_VW_EVENTS-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHMS_VW_EVENTS_EXTRACT
TOTAL = ZHMS_VW_EVENTS_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZHMS_VW_EVENTS-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZHMS_VW_EVENTS'
...
TOTAL = ZHMS_VW_EVENTS_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZHMS_VW_EVENTS-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZHMS_VW_EVENTS-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZHMS_VW_EVENTS'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZHMS_VW_EVENTS-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHMS_VW_EVENTS_EXTRACT
TOTAL = ZHMS_VW_EVENTS_TOTAL
