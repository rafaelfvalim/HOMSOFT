*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZHMS_VW_EVV_LAYT
*   generation date: 31.05.2013 at 17:20:08 by user RAFAEL
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZHMS_VW_EVV_LAYT    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZHMS_VW_EVV_LAYT'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZHMS_VW_EVV_LAYT_EXTRACT
TOTAL = ZHMS_VW_EVV_LAYT_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZHMS_VW_EVV_LAYT'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZHMS_VW_EVV_LAYT-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHMS_VW_EVV_LAYT_EXTRACT
TOTAL = ZHMS_VW_EVV_LAYT_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZHMS_VW_EVV_LAYT-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZHMS_VW_EVV_LAYT'
...
TOTAL = ZHMS_VW_EVV_LAYT_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZHMS_VW_EVV_LAYT-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZHMS_VW_EVV_LAYT-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZHMS_VW_EVV_LAYT'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZHMS_VW_EVV_LAYT-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHMS_VW_EVV_LAYT_EXTRACT
TOTAL = ZHMS_VW_EVV_LAYT_TOTAL
