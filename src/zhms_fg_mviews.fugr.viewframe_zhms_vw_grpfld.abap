*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZHMS_VW_GRPFLD
*   generation date: 08.05.2013 at 21:09:08 by user CLEBER
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZHMS_VW_GRPFLD      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZHMS_VW_GRPFLD'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZHMS_VW_GRPFLD_EXTRACT
TOTAL = ZHMS_VW_GRPFLD_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZHMS_VW_GRPFLD'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZHMS_VW_GRPFLD-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHMS_VW_GRPFLD_EXTRACT
TOTAL = ZHMS_VW_GRPFLD_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZHMS_VW_GRPFLD-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZHMS_VW_GRPFLD'
...
TOTAL = ZHMS_VW_GRPFLD_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZHMS_VW_GRPFLD-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZHMS_VW_GRPFLD-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZHMS_VW_GRPFLD'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZHMS_VW_GRPFLD-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHMS_VW_GRPFLD_EXTRACT
TOTAL = ZHMS_VW_GRPFLD_TOTAL
