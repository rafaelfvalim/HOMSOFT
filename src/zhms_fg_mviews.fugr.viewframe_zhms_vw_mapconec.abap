*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZHMS_VW_MAPCONEC
*   generation date: 20.02.2014 at 16:25:41 by user TATIANA
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZHMS_VW_MAPCONEC    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZHMS_VW_MAPCONEC'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZHMS_VW_MAPCONEC_EXTRACT
TOTAL = ZHMS_VW_MAPCONEC_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZHMS_VW_MAPCONEC'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZHMS_VW_MAPCONEC-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHMS_VW_MAPCONEC_EXTRACT
TOTAL = ZHMS_VW_MAPCONEC_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZHMS_VW_MAPCONEC-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZHMS_VW_MAPCONEC'
...
TOTAL = ZHMS_VW_MAPCONEC_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZHMS_VW_MAPCONEC-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZHMS_VW_MAPCONEC-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZHMS_VW_MAPCONEC'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZHMS_VW_MAPCONEC-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHMS_VW_MAPCONEC_EXTRACT
TOTAL = ZHMS_VW_MAPCONEC_TOTAL
