*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZHMS_VW_MESSAGIN
*   generation date: 12.04.2013 at 18:56:05 by user RAFAEL
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZHMS_VW_MESSAGIN    .
*"----------------------------------------------------------------------
*"*"Interface local:
*"  IMPORTING
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZHMS_VW_MESSAGIN'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZHMS_VW_MESSAGIN_EXTRACT
TOTAL = ZHMS_VW_MESSAGIN_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZHMS_VW_MESSAGIN'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZHMS_VW_MESSAGIN-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHMS_VW_MESSAGIN_EXTRACT
TOTAL = ZHMS_VW_MESSAGIN_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZHMS_VW_MESSAGIN-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZHMS_VW_MESSAGIN'
...
TOTAL = ZHMS_VW_MESSAGIN_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZHMS_VW_MESSAGIN-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZHMS_VW_MESSAGIN-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZHMS_VW_MESSAGIN'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZHMS_VW_MESSAGIN-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHMS_VW_MESSAGIN_EXTRACT
TOTAL = ZHMS_VW_MESSAGIN_TOTAL
