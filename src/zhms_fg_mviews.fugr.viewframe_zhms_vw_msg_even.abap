*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZHMS_VW_MSG_EVEN
*   generation date: 12.04.2013 at 18:54:41 by user RAFAEL
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZHMS_VW_MSG_EVEN    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZHMS_VW_MSG_EVEN'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZHMS_VW_MSG_EVEN_EXTRACT
TOTAL = ZHMS_VW_MSG_EVEN_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZHMS_VW_MSG_EVEN'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZHMS_VW_MSG_EVEN-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHMS_VW_MSG_EVEN_EXTRACT
TOTAL = ZHMS_VW_MSG_EVEN_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZHMS_VW_MSG_EVEN-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZHMS_VW_MSG_EVEN'
...
TOTAL = ZHMS_VW_MSG_EVEN_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZHMS_VW_MSG_EVEN-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZHMS_VW_MSG_EVEN-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZHMS_VW_MSG_EVEN'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZHMS_VW_MSG_EVEN-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHMS_VW_MSG_EVEN_EXTRACT
TOTAL = ZHMS_VW_MSG_EVEN_TOTAL
