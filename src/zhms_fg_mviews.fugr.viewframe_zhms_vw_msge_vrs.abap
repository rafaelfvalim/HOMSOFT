*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZHMS_VW_MSGE_VRS
*   generation date: 08.04.2013 at 11:28:48 by user CLEBER
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZHMS_VW_MSGE_VRS    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZHMS_VW_MSGE_VRS'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZHMS_VW_MSGE_VRS_EXTRACT
TOTAL = ZHMS_VW_MSGE_VRS_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZHMS_VW_MSGE_VRS'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZHMS_VW_MSGE_VRS-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHMS_VW_MSGE_VRS_EXTRACT
TOTAL = ZHMS_VW_MSGE_VRS_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZHMS_VW_MSGE_VRS-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZHMS_VW_MSGE_VRS'
...
TOTAL = ZHMS_VW_MSGE_VRS_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZHMS_VW_MSGE_VRS-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZHMS_VW_MSGE_VRS-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZHMS_VW_MSGE_VRS'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZHMS_VW_MSGE_VRS-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHMS_VW_MSGE_VRS_EXTRACT
TOTAL = ZHMS_VW_MSGE_VRS_TOTAL
