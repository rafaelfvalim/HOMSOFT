*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZHMS_VW_MSGEV_LT
*   generation date: 18.02.2014 at 11:00:43 by user TATIANA
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZHMS_VW_MSGEV_LT    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZHMS_VW_MSGEV_LT'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZHMS_VW_MSGEV_LT_EXTRACT
TOTAL = ZHMS_VW_MSGEV_LT_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZHMS_VW_MSGEV_LT'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZHMS_VW_MSGEV_LT-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHMS_VW_MSGEV_LT_EXTRACT
TOTAL = ZHMS_VW_MSGEV_LT_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZHMS_VW_MSGEV_LT-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZHMS_VW_MSGEV_LT'
...
TOTAL = ZHMS_VW_MSGEV_LT_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZHMS_VW_MSGEV_LT-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZHMS_VW_MSGEV_LT-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZHMS_VW_MSGEV_LT'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZHMS_VW_MSGEV_LT-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHMS_VW_MSGEV_LT_EXTRACT
TOTAL = ZHMS_VW_MSGEV_LT_TOTAL
