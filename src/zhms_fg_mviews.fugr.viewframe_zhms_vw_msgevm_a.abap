*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZHMS_VW_MSGEVM_A
*   generation date: 08.04.2013 at 20:14:47 by user RAFAEL
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZHMS_VW_MSGEVM_A    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZHMS_VW_MSGEVM_A'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZHMS_VW_MSGEVM_A_EXTRACT
TOTAL = ZHMS_VW_MSGEVM_A_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZHMS_VW_MSGEVM_A'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZHMS_VW_MSGEVM_A-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHMS_VW_MSGEVM_A_EXTRACT
TOTAL = ZHMS_VW_MSGEVM_A_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZHMS_VW_MSGEVM_A-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZHMS_VW_MSGEVM_A'
...
TOTAL = ZHMS_VW_MSGEVM_A_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZHMS_VW_MSGEVM_A-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZHMS_VW_MSGEVM_A-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZHMS_VW_MSGEVM_A'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZHMS_VW_MSGEVM_A-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHMS_VW_MSGEVM_A_EXTRACT
TOTAL = ZHMS_VW_MSGEVM_A_TOTAL
