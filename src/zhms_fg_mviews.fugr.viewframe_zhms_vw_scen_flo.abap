*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZHMS_VW_SCEN_FLO
*   generation date: 06.02.2014 at 16:13:05 by user DAVID
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZHMS_VW_SCEN_FLO    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZHMS_VW_SCEN_FLO'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZHMS_VW_SCEN_FLO_EXTRACT
TOTAL = ZHMS_VW_SCEN_FLO_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZHMS_VW_SCEN_FLO'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZHMS_VW_SCEN_FLO-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHMS_VW_SCEN_FLO_EXTRACT
TOTAL = ZHMS_VW_SCEN_FLO_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZHMS_VW_SCEN_FLO-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZHMS_VW_SCEN_FLO'
...
TOTAL = ZHMS_VW_SCEN_FLO_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZHMS_VW_SCEN_FLO-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZHMS_VW_SCEN_FLO-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZHMS_VW_SCEN_FLO'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZHMS_VW_SCEN_FLO-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHMS_VW_SCEN_FLO_EXTRACT
TOTAL = ZHMS_VW_SCEN_FLO_TOTAL
