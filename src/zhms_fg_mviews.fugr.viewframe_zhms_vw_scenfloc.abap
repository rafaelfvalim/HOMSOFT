*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZHMS_VW_SCENFLOC
*   generation date: 21.01.2014 at 17:01:17 by user TATIANA
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZHMS_VW_SCENFLOC    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZHMS_VW_SCENFLOC'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZHMS_VW_SCENFLOC_EXTRACT
TOTAL = ZHMS_VW_SCENFLOC_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZHMS_VW_SCENFLOC'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZHMS_VW_SCENFLOC-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHMS_VW_SCENFLOC_EXTRACT
TOTAL = ZHMS_VW_SCENFLOC_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZHMS_VW_SCENFLOC-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZHMS_VW_SCENFLOC'
...
TOTAL = ZHMS_VW_SCENFLOC_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZHMS_VW_SCENFLOC-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZHMS_VW_SCENFLOC-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZHMS_VW_SCENFLOC'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZHMS_VW_SCENFLOC-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHMS_VW_SCENFLOC_EXTRACT
TOTAL = ZHMS_VW_SCENFLOC_TOTAL
