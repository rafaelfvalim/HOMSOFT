*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZHMS_VW_SECURITY
*   generation date: 12/17/2018 at 03:35:39 by user DEVELOPER1
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZHMS_VW_SECURITY    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZHMS_VW_SECURITY'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZHMS_VW_SECURITY_EXTRACT
TOTAL = ZHMS_VW_SECURITY_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZHMS_VW_SECURITY'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZHMS_VW_SECURITY-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHMS_VW_SECURITY_EXTRACT
TOTAL = ZHMS_VW_SECURITY_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZHMS_VW_SECURITY-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZHMS_VW_SECURITY'
...
TOTAL = ZHMS_VW_SECURITY_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZHMS_VW_SECURITY-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZHMS_VW_SECURITY-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZHMS_VW_SECURITY'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZHMS_VW_SECURITY-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHMS_VW_SECURITY_EXTRACT
TOTAL = ZHMS_VW_SECURITY_TOTAL
