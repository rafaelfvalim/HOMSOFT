*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZHMS_VW_TYPE
*   generation date: 02.12.2019 at 11:50:30
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZHMS_VW_TYPE        .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZHMS_VW_TYPE'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZHMS_VW_TYPE_EXTRACT
TOTAL = ZHMS_VW_TYPE_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZHMS_VW_TYPE'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZHMS_VW_TYPE-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHMS_VW_TYPE_EXTRACT
TOTAL = ZHMS_VW_TYPE_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZHMS_VW_TYPE-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZHMS_VW_TYPE'
...
TOTAL = ZHMS_VW_TYPE_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZHMS_VW_TYPE-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZHMS_VW_TYPE-UPD_FLAG NE SPACE.
