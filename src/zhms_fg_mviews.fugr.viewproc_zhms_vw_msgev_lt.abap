*---------------------------------------------------------------------*
*    program for:   VIEWPROC_ZHMS_VW_MSGEV_LT
*   generation date: 18.02.2014 at 11:00:43 by user TATIANA
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWPROC_ZHMS_VW_MSGEV_LT     .
*"----------------------------------------------------------------------
*"*"Interface global:
*"  IMPORTING
...
ASSIGN ZHMS_VW_MSGEV_LT TO <TABLE1>.
ASSIGN *ZHMS_VW_MSGEV_LT TO <INITIAL>.
ASSIGN STATUS_ZHMS_VW_MSGEV_LT TO <STATUS>.
...
*----------------------------------------------------------------------*
  IF FCODE EQ READ OR FCODE EQ READ_AND_EDIT.
    ...
    ELSE.
PERFORM GET_DATA_ZHMS_VW_MSGEV_LT.
    ENDIF.
...
*....................................................................*
    ...
    WHEN SAVE.                           " Write data into database
      ...
      IF <STATUS>-UPD_FLAG NE SPACE.
        ...
        ELSE.
          IF SY-SUBRC EQ 0.
PERFORM DB_UPD_ZHMS_VW_MSGEV_LT.
          ENDIF.
        ENDIF.
...
*.......................................................................
  ENDCASE.
MOVE STATUS_ZHMS_VW_MSGEV_LT-UPD_FLAG TO UPDATE_REQUIRED.
ENDFUNCTION.
